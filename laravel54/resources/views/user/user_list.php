...
<!--李超飞-->
                ...
                <div class="user_info">
                    ...
                    <a id="edit_nick" href="#" class="change_n clickstat" eid="click/grzx/myinfo/edit" eid_desc="点击/个人中心/我的信息/编辑">编辑</a>
                    ...
                    <p class="user_msg">
                        ...
                        <span class="user_add">
                               <?=$users['home']?>                          </span>
                        <span class="user_ps"><?=$users['sign']?></span>
                    </p>
                    ...
                    <ul id="my_estate">
                        <li>
                            ...
                            <span class="tool-info">
                                        <i class="num" style="min-width:28px;"><?=$money['jin']?></i>
                        ...
                        <li>
                            ...
                            <span class="tool-info">
                                        <i class="num" style="min-width:28px;"><?=$money['yin']?></i>
                                                                                    <span class="hidden tool_msg">
                                                <i class="up_arrows"></i>
...
<div class="bg"></div>
<!--异步上传引入开始-->
<script src="ybsc.js"></script>
<!--异步上传引入结束-->
<!-- 修改头像 -->
<div id="the_img">
    <div class="box_top" style="cursor: move;">
        <span id="before"></span>
        <span style="font-size:16px; font-weight: 300">修改头像</span>
        <a href="javascript:void(0);" class="close">关闭</a>
    </div>
