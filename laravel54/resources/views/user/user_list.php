                ...
                <div class="hy-nav-right nav-user success-login" style="display: block;">
                    ...
                    <div class="nav-expand-list">
                        ...
                        <div class="tt-user-card">
                            <a class="btn-exit" id="nav-loggout" href="?r=login/loginout"><i class="hy-nav-exit-icon"></i><span>退出</span></a>
                            <div class="u-info">
                                ...
                                <div class="exp clearfix">
                                    <div class="between">
                                        <span class="from" id="J_huyaNavUserCardExpFrom">LV-1</span>
                                        <div class="bar-cnt">
                                            <p id="J_huyaNavUserCardBarInfo">今日获得
                                                <em>0</em>
                                                点经验值，升级还需
                                                <em>140</em>
                                                点</p>
                                                    <p class="bar">
                                                <i id="J_huyaNavUserCardExpBar" style="width: 30%;"><b class="J_huyaNavUserCardExpText"></b></i>
                                                <span class="J_huyaNavUserCardExpText">60/120</span>
                                            </p>
                                        </div>
                                        <span class="to" id="J_huyaNavUserCardExpTo">LV-10</span>
                                    </div>
                                </div>
                            </div>
                            <div class="u-assets">
                                <div class="bd">
                                    ...
                                    <ul class="type">
                                        <li><i class="gold-bean"></i><em id="J_huyaNavUserCardAssetsGb"><?=$money['jin']?></em></li>
                                        <li class="type-ticket"><i class="gold-ticket"></i><em id="J_huyaNavUserCardAssetsTk">...</em></li>
                                        <li><i class="silver-bean"></i><em id="J_huyaNavUserCardAssetsSb"><?=$money['yin']?></em></li>
                                    </ul>
