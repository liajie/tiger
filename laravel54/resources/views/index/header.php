    ...
    <div class="duya-header-bd clearfix">
        ...
        <div class="duya-header-search clearfix" id="J_duyaHdSearch">
            <form method="get" id="searchForm_id" name="navSearchForm" action="http://www.huya.com/search.php"
                ...
                <input type="text" name="hsk" value="主播、频道、游戏" id="channel_name">
                <button type="button" class="btn-search clickstat" eid="click/search/searchbutton"
                        eid_desc="点击/搜索/搜索按钮"></button>
            </form>
        </div>
        <script>
            $('.btn-search').click(function () {
                location.href = '/?r=search/search_find&name='+$('#channel_name').val()
            })
        </script>
                ...
                <div class="nav-expand-list">
                    ...
                    <div class="tt-user-card">
                        ...
                        <div class="u-info">
                            ...
                            <p class="user-sign" id="J_huyaNavUserCardSign"><a href="javascript:vido(0)"
                                                                               class="edit_sign">
                                        <span id="sign">
