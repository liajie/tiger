					...
					<div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" id="gbox_grid-table" dir="ltr" style="width: 1119px;">
						...
						<div class="ui-jqgrid-view" id="gview_grid-table" style="width: 1119px;">
							<div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix">
								...
								<span class="ui-jqgrid-title">用户财产管理</span></div>
									...
									<table cellspacing="0" cellpadding="0" border="0" aria-labelledby="gbox_grid-table" role="grid" style="width:1101px" class="ui-jqgrid-htable">
										<thead>
											<tr role="rowheader" class="ui-jqgrid-labels">
												<th class="ui-state-default ui-th-column ui-th-ltr" role="columnheader" id="grid-table_cb" style="width: 35px;">
													<div id="jqgh_grid-table_cb"><input type="checkbox" class="cbox" id="cb_grid-table" role="checkbox" style="width: 20px"><span style="width:90px" class="s-ico"><span class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr" sort="asc"></span><span class="ui-grid-ico-sort ui-icon-desc ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-ltr" sort="desc"></span></span>
													</div>
												</th>

												<th class="ui-state-default ui-th-column ui-th-ltr" role="columnheader" id="grid-table_id" style="width: 20px;"><span class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
												...
												<th class="ui-state-default ui-th-column ui-th-ltr" role="columnheader" id="grid-table_sdate" style="width: 40px;">
													<span class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
													<div id="jqgh_grid-table_sdate" class="ui-jqgrid-sortable">注册日期<span style="display:none" class="s-ico">
												...
												<th class="ui-state-default ui-th-column ui-th-ltr" role="columnheader" id="grid-table_name" style="width: 20px;"><span class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
													<div id="jqgh_grid-table_name" class="ui-jqgrid-sortable">用户名<span style="display:none" class="s-ico"><span class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr" sort="asc"></span><span class="ui-grid-ico-sort ui-icon-desc ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-ltr" sort="desc"></span></span>
													</div>
												</th>

												<th class="ui-state-default ui-th-column ui-th-ltr" role="columnheader" id="grid-table_ship" style="width: 20px;"><span class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
													<div id="jqgh_grid-table_ship" class="ui-jqgrid-sortable">个人积分<span style="display:none" class="s-ico"><span class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr" sort="asc"></span><span class="ui-grid-ico-sort ui-icon-desc ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-ltr" sort="desc"></span></span>
													</div>
												</th>


												<th class="ui-state-default ui-th-column ui-th-ltr" role="columnheader" id="grid-table_note" style="width: 20px;"><span class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
												...
												<th class="ui-state-default ui-th-column ui-th-ltr" role="columnheader" id="grid-table_ship" style="width: 30px;"><span class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
                                                                                                													<div id="jqgh_grid-table_ship" class="ui-jqgrid-sortable">金豆<span style="display:none" class="s-ico"><span class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr" sort="asc"></span><span class="ui-grid-ico-sort ui-icon-desc ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-ltr" sort="desc"></span></span>
                                                                                                													</div>
                                                                                                												</th>
                                                <th class="ui-state-default ui-th-column ui-th-ltr" role="columnheader" id="grid-table_ship" style="width: 60px;"><span class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
                                                													<div id="jqgh_grid-table_ship" class="ui-jqgrid-sortable">银豆<span style="display:none" class="s-ico"><span class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr" sort="asc"></span><span class="ui-grid-ico-sort ui-icon-desc ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-ltr" sort="desc"></span></span>
                                                													</div>
                                                												</th>
									...
									<table cellspacing="0" cellpadding="0" border="0" id="grid-table" tabindex="0" role="grid" aria-multiselectable="true" aria-labelledby="gbox_grid-table" class="ui-jqgrid-btable" style="width: 1101px;">
										<tbody>
											<tr style="height:auto "  role="row" class="jqgfirstrow">
												<td style="height:0px;width:15px;" role="gridcell"></td>
												<td style="height:0px;width:10px;" role="gridcell"></td>
												<td style="height:0px;width:30px;" role="gridcell"></td>
												<td style="height:0px;width:27px;" role="gridcell"></td>
												<td style="height:0px;width:10px;" role="gridcell"></td>
												<td style="height:0px;width:10px;" role="gridcell"></td>
												<td style="height:0px;width:10px;" role="gridcell"></td>
												<td style="height:0px;width:10px;" role="gridcell"></td>
											...
											<tr v-for="li in money" class="ui-widget-content jqgrow ui-row-ltr" tabindex="-1" id="1" role="row">
												<td aria-describedby="grid-table_cb" style="text-align:center;width: 50px;" role="gridcell"><input type="checkbox" name="jqg_grid-table_1" class="cbox" id="jqg_grid-table_1" role="checkbox"></td>

												<td aria-describedby="grid-table_id" title="1" style="" role="gridcell">{{li.u_id}}</td>
												<td aria-describedby="grid-table_sdate" title="2007-12-03" style="" role="gridcell">{{li.user_addTime}}</td>
												<td aria-describedby="grid-table_name" title="Desktop Computer" style="" role="gridcell">{{li.username}}</td>

												<td aria-describedby="grid-table_ship" title="FedEx" style="" role="gridcell">{{li.mynum}}</td>
												<td aria-describedby="grid-table_note" title="note" style="" role="gridcell">{{li.sex}}</td>
												<td aria-describedby="grid-table_jin" title="note" style="" role="gridcell">{{li.a_money}}</td>
												<td aria-describedby="grid-table_yin" title="note" style="" role="gridcell">{{li.b_money}}</td>
											</tr>
										</tbody>
									</table>
								</div>
...
<script>
	...
	//修改账号状态
	function user_start_d(li,u_id,user_start)
	{
		$.ajax({
			dataType:'jsonp',
			url:host+'?r=user/user_start',
			data:{u_id:u_id,user_start:user_start},
			success:function(e)
			{
				common(e.error)
				if(e.error=='200')
